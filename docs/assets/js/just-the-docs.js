(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://harshita-mindfire.github.io/german-for-beginners/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://harshita-mindfire.github.io/german-for-beginners/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://harshita-mindfire.github.io/german-for-beginners/assets/css/just-the-docs-' + theme + ".css"
      );
    };
